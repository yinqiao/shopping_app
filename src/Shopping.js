...
class Shopping1 extends Component{
    constructor(){
        ...
        this.state = {
            ...
            products: [{
                'index': '0',
                'path': 'https://gw.alicdn.com/tfs/TB1K0zdwmrqK1RjSZK9XXXyypXa-300-200.jpg',
                'name': 'apple',
                'price': '4.99',
                "quantity": 10
            }, {
                'index': '1',
                'path': 'https://gw.alicdn.com/tfs/TB1IEPiwmzqK1RjSZFHXXb3CpXa-300-200.jpg',
                'name': 'pear',
                'price': '3.59',
                "quantity": 8
            }, {
                'index': '2',
                'path': 'https://gw.alicdn.com/tfs/TB1RxTjwcbpK1RjSZFyXXX_qFXa-300-200.jpg',
                'name': 'watermelen',
                'price': '6.99',
                "quantity": 15
            }, {
                'index': '3',
                'path': 'https://gw.alicdn.com/tfs/TB1pwzfwmzqK1RjSZFLXXcn2XXa-300-200.jpg',
                'name': 'banana',
                'price': '2.99',
                "quantity": 5
            }],
    ...
    handleRemove(quantity,id,event){
